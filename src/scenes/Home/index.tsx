...
const Home = ({ setSelectedPage }: Props) => {
  ...
  return (
    <section
      id="home"
      className="gap-16 bg-gray-20 py-10 md:h-full md:pb-0 overflow-y-hidden max-w-[100vw]"
    >
        ...
        <div className="z-10 mt-32 md:basis-3/5">
          ...
          >
            <div className=" relative">
              <div className="before:absolute before:-top-20 before:content-evolvetext before:-left-20 before:z-[-1] before:hidden md:before:block">
